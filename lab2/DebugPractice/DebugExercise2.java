...
public class DebugExercise2 {
    ...
    public static int max(int a, int b) {
        int w = (b - a) >> 31;
        /* If b >= a, b-a >= 0, first bit of b-a is 0, after 31 times move, w will be 32 bits of 0  */
        /* Else if b < a, b-a < 0, first bit of b-a is 1, after 31 times move, w will be 32 bits of 1*/

        /* If you're stepping into this function, click the
           step out button because you're not going to learn anything. */
        int z = ~(b - a) >> 31;
        /* If w = 000..., z = 111... ; else w = 111..., z = 000... */

        /* If b >= a, w = 000..., z = 111...; else a < b, w = 111..., z = 000... */
        /* return b if b>= a else return a */
        int max = a & w | b & z;
        return max;
    }
